...
{
	CreatePlayerDataContext(ClientSession* owner, const wchar_t* name) : DatabaseJobContext(owner)
	{
...
{
	DeletePlayerDataContext(ClientSession* owner, int playerId) : DatabaseJobContext(owner),
	mPlayerId(playerId)
	{
	}
